...
/**
 * Boots the scenario: procedural terrain, central tower, enemy spawner,
 * predetermined defender slots, first-person player, and coin economy.
 */
UCLASS()
...
public:
	...
	/** Placement budget — keep ≥ 3 × pathway count (terrain spawns ≥3 pads/path). */
